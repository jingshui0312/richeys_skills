...
def get_transcript(video_id: str, max_chars: int = 4000, lang_priority: list = None) -> Dict[str, Any]:
    """
...
def main():
    ...
    parser.add_argument('--max-transcript', type=int, default=4000,
                        help='Max transcript characters to extract (default: 4000, use less for token savings)')
