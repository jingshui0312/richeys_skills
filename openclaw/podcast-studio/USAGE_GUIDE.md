...
A: 编辑 `/root/clawd/skills/podcast-studio/scripts/podcast_studio.py` 中的 `_script_template_*` 方法。
...
- 查看完整文档：`/root/clawd/skills/podcast-studio/SKILL.md`
- 查看更新日志：`/root/clawd/skills/podcast-studio/UPDATE_2026-02-11.md`
- 运行测试：`python3 /root/clawd/skills/podcast-studio/scripts/script_generator.py`
