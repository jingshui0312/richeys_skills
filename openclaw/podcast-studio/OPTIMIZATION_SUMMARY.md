...
# 修复后
load_dotenv("/path/to/openclaw/skills/article-extractor/.env")
...
export NOTION_PARENT_PAGE_ID="YOUR_NOTION_PAGE_ID"
```
...
- **配置指南**：`/path/to/openclaw/skills/podcast-studio/NOTION_INTEGRATION.md`
- **API 配置**：`/path/to/openclaw/skills/podcast-studio/config.json`
- **上传脚本**：`/path/to/openclaw/skills/podcast-studio/scripts/upload_to_notion.py`
- **记忆文档**：`/path/to/openclaw/memory/2026-02-28.md`
